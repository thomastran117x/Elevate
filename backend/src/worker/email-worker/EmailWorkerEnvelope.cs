...
public sealed record EmailWorkerEnvelope(
    string Topic,
    int Partition,
    long Offset,
    string? Key,
...
{
    public static EmailWorkerEnvelope FromConsumeResult(ConsumeResult<string, string> result)
    {
        ...
        return new EmailWorkerEnvelope(
            result.Topic,
